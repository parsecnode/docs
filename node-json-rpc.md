...
```
 parsecd --rpc-bind-ip=0.0.0.0 --rpc-bind-port=32616 
```
...
```
 http://126.0.1.100:32616/json_rpc
...
`<service port>`     | Daemon RPC port, by default it is bound to 32616 port, but it can be manually bound to any port you want
